...
theme_list_ttk: tuple[str] = ttk.Style().theme_names()
theme_list_ttkthemes = root.get_themes()
theme_list_all = set(list(theme_list_ttk) + list(theme_list_ttkthemes))
print(theme_list_ttkthemes)
...
# Sub menu
for theme in sorted(theme_list_all):
